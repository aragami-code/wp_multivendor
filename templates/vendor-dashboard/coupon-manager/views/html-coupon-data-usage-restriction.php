...
<div role="tabpanel" class="tab-pane fade" id="usage_restriction_coupon_data">
    <div class="row-padding">
        <?php do_action( 'wcmb_afm_before_usage_restriction_coupon_data', $post->ID, $coupon ); ?>
        ...
        <div class="form-group-row">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9 coupon-products-wrap">
                    <select id="products" class="form-control wc-enhanced-select" multiple="multiple" name="product_ids[]" data-placeholder="<?php esc_attr_e( 'Any products', 'MB-multivendor' ); ?>">
                        <?php
        ...
        <?php do_action( 'wcmb_afm_after_usage_restriction_coupon_data', $post->ID, $coupon ); ?>
    </div>
</div>