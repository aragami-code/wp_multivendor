...
if($total_products == 0) {
    _e('No products Available.', 'MB-multivendor');
} else {
?>
<div class="wcmb_product_stats_wrap">
    ...
    <div class="p_stats_data">
        <ul class="list-group">
            <li class="list-group-item justify-content-between">
                ...
                <p><?php _e('Published', 'MB-multivendor');?></p>
            ...
            <li class="list-group-item justify-content-between">
                ...
                <p><?php _e('Pending', 'MB-multivendor');?></p>
            ...
            <li class="list-group-item justify-content-between">
                ...
                <p><?php _e('Draft', 'MB-multivendor');?></p>
            ...
            <li class="list-group-item justify-content-between">
                ...
                <p><?php _e('Not Approved', 'MB-multivendor');?></p>
