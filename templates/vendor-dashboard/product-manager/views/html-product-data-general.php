...
<div role="tabpanel" class="tab-pane fade" id="general_product_data">
    <div class="row-padding">
        <?php do_action( 'wcmb_afm_before_general_product_data', $post->ID, $product_object, $post ); ?>
        <?php
        $product_url_visibility = apply_filters( 'general_tab_product_url_section', array( 'external' ) );
        if ( call_user_func_array( "wcmb_is_allowed_product_type", $product_url_visibility ) ) :
        ...
        if ( call_user_func_array( "wcmb_is_allowed_product_type", $pricing_visibility ) ) :
            ...
            <div class="form-group-row pricing <?php echo $show_classes; ?>"> 
                ...
                <?php do_action( 'wcmb_afm_product_options_pricing', $post->ID, $product_object, $post ); ?> 
            </div>
        <?php endif; ?>
        <?php if ( $WCMb->vendor_caps->vendor_can( 'downloadable' ) ) : ?>
            <div class="form-group-row show_if_downloadable"> 
                ...
                <?php do_action( 'wcmb_afm_product_options_downloads', $post->ID, $product_object, $post ); ?>
            </div>
        <?php endif; ?>
        <?php
        $tax_visibility = apply_filters( 'general_tab_tax_section', array( 'simple', 'external', 'variable' ) );
        if ( apply_filters( 'wcmb_can_vendor_configure_tax', wc_tax_enabled() ) && call_user_func_array( "wcmb_is_allowed_product_type", $tax_visibility ) ) :
        ...
        <?php endif; ?>
        <?php do_action( 'wcmb_afm_after_general_product_data', $post->ID, $product_object, $post ); ?>
    </div>
</div>