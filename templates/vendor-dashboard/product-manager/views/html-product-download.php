...
<tr>
	...
	<td class="file_url_choose"><a href="#" class="button upload_file_button" data-choose="<?php esc_attr_e( 'Choose file', 'woocommerce' ); ?>" data-update="<?php esc_attr_e( 'Insert file URL', 'woocommerce' ); ?>" title="<?php echo esc_html__( 'Choose file', 'woocommerce' ); ?>"><i class="wcmb-font ico-upload-image-icon"></i></a></td>
	<td><a href="#" class="delete" title="<?php esc_html_e( 'Delete', 'woocommerce' ); ?>"><i class="wcmb-font ico-delete-icon"></i></a></td>
</tr>