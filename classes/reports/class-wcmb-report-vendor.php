...
class WCMb_Report_Vendor extends WC_Admin_Report {
    ...
    public function output_report() {
        ...
        if (!empty($all_vendors) && is_array($all_vendors)) {
            ...
            wp_localize_script('wcmb_report_js', 'wcmb_report_vendor', array('vendor_report' => $vendor_report,
                'report_bk' => $report_bk,
            ...
            $html_chart = '<tr><td colspan="3">' . __('Your store has no vendors.', 'MB-multivendor') . '</td></tr>';
        }

        include( $WCMb->plugin_path . '/classes/reports/views/html-wcmb-report-by-vendor.php');
    }
