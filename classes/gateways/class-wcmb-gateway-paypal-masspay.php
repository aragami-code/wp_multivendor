...
class WCMb_Gateway_Paypal_Masspay extends WCMb_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->gateway_title = __('Paypal masspay', 'MB-multivendor');
        $this->payment_gateway = $this->id;
        $this->enabled = get_wcmb_vendor_settings('payment_method_paypal_masspay', 'payment');
        $this->api_username = get_wcmb_vendor_settings('api_username', 'payment', 'paypal_masspay');
        $this->api_password = get_wcmb_vendor_settings('api_pass', 'payment', 'paypal_masspay');
        $this->api_signature = get_wcmb_vendor_settings('api_signature', 'payment', 'paypal_masspay');
        $this->api_endpoint = 'https://api-3t.paypal.com/nvp';
        if (get_wcmb_vendor_settings('is_testmode', 'payment', 'paypal_masspay') == 'Enable') {
            $this->test_mode = true;
    ...
    public function validate_request() {
        ...
        if ($this->enabled != 'Enable') {
            ...
            $this->message[] = array('message' => __('Paypal masspay setting is not configured properly please contact site administrator', 'MB-multivendor'), 'type' => 'error');
            return false;
