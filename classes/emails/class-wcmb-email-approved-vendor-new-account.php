...
if (!class_exists('WC_Email_Approved_New_Vendor_Account')) :
    ...
    class WC_Email_Approved_New_Vendor_Account extends WC_Email {
        ...
        function __construct() {
            ...
            $this->title = __('Approved Vendor Account', 'MB-multivendor');
        ...
        public function get_default_subject() {
            return apply_filters('wcmb_approved_vendor_new_account_email_subject', __('Your account on {site_title}', 'MB-multivendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('wcmb_approved_vendor_new_account_email_heading', __('Welcome to {site_title}', 'MB-multivendor'), $this->object);
        }
