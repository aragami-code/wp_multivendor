...
class WC_Email_Vendor_Orders_Stats_Report extends WC_Email {
    ...
    function __construct() {
        ...
        $this->title 		= __( 'Vendor orders stats report', 'MB-multivendor' );
        $this->description		= __( 'Vendor gets their weekly or monthly order reports.', 'MB-multivendor');
    ...
    public function get_default_subject() {
        return apply_filters( 'wcmb_vendor_orders_stats_report_email_subject', __( '{STORE_NAME}, your orders report', 'MB-multivendor'), $this->object );
    }
    ...
    public function get_default_heading() {
        return apply_filters( 'wcmb_vendor_orders_stats_report_email_heading', __( '{STORE_NAME} orders report', 'MB-multivendor'),$this->object );
    }
    ...
    public function get_attachments() {
        return apply_filters( 'wcmb_vendor_orders_stats_report_email_attachments', $this->attachments, $this->id, $this->object );
    }
