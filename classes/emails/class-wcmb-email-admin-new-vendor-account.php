...
if (!class_exists('WC_Email_Admin_New_Vendor_Account')) :
    ...
    class WC_Email_Admin_New_Vendor_Account extends WC_Email {
        ...
        function __construct() {
            ...
            $this->title = __('Admin New Vendor Account', 'MB-multivendor');
            $this->description = __('New emails are sent when a user applies to be a vendor.', 'MB-multivendor');
        ...
        public function get_default_subject() {
            return apply_filters('wcmb_admin_new_vendor_email_subject', __('[{site_title}] New Vendor Account', 'MB-multivendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('wcmb_admin_new_vendor_email_heading', __('New Vendor Account', 'MB-multivendor'), $this->object);
        }
