...
class WC_Email_Vendor_Contact_Widget extends WC_Email {
    ...
    function __construct() {
        ...
        $this->title 		= __( 'Vendor Contact Email', 'MB-multivendor' );
        $this->description		= __( 'Vendor contact email via customer.', 'MB-multivendor');
    ...
    public function get_default_subject() {
        $subject = __( '[{site_title}] Contact Vendor', 'MB-multivendor');
        if( isset($this->object['subject']) && !empty($this->object['subject']) ){
            $subject = $subject . ' - ' . $this->object['subject'];
        }
        return apply_filters( 'wcmb_vendor_contact_widget_email_subject', $subject, $this->object );
    }
    ...
    public function get_default_heading() {
        return apply_filters( 'wcmb_vendor_contact_widget_email_heading', __( "{STORE_NAME}'s Customer contact", 'MB-multivendor'), $this->object );
    }
    ...
    public function get_headers() {
        ...
        if( apply_filters( 'wcmb_vendor_contact_widget_email_goes_to_admin', true, $this->object ) ) {
        ...
        return apply_filters( 'wcmb_vendor_contact_widget_email_headers', $header, $this->id, $this->object );
    }
