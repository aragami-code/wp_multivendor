...
class WCMb_Product_QNA {
    ...
    public function __construct() {
        global $wpdb;
        $this->question_table = $wpdb->prefix.'wcmb_cust_questions';
        $this->answer_table = $wpdb->prefix.'wcmb_cust_answers';
        add_action( 'wcmb_product_qna_delete_question', array($this, 'wcmb_product_qna_delete_question'));
    }
     ...
     *
     * @since 3.0.0
     * @param wcmb_Product_QNA question $data
     */
    public function createQuestion( $data ) {
        global $wpdb;
        $data = apply_filters( 'wcmb_product_qna_insert_question_data', $data );
     ...
     *
     * @since 3.0.0
     * @param wcmb_Product_QNA question $ques_ID
     * @param wcmb_Product_QNA question $data
     */
    public function updateQuestion( $ques_ID, $data ) {
        global $wpdb;
        if ( $ques_ID ) {
            $data = apply_filters( 'wcmb_product_qna_update_question_data', $data, $ques_ID );
    ...
    public function deleteQuestion( $ques_ID ) {
        if ( $ques_ID ) {
            ...
            do_action( 'wcmb_product_qna_delete_question', $ques_ID );
        }
    }
     ...
     * @param wcmb_Product_QNA question $ques_ID
     */
    public function wcmb_product_qna_delete_question( $ques_ID ){
        if($ques_ID){
     ...
     *
     * @since 3.0.0
     * @param wcmb_Product_QNA answer $data
     */
    public function createAnswer( $data ) {
        global $wpdb;
        $data = apply_filters( 'wcmb_product_qna_insert_answer_data', $data );
     ...
     *
     * @since 3.0.0
     * @param wcmb_Product_QNA answer $ans_ID
     * @param wcmb_Product_QNA answer $data
     */
    public function updateAnswer( $ans_ID, $data ) {
        global $wpdb;
        if ( $ans_ID ) {
            $data = apply_filters( 'wcmb_product_qna_update_answer_data', $data, $ans_ID );
    ...
    public function deleteAnswer( $ans_ID ) {
        if ( $ans_ID ) {
            ...
            do_action( 'wcmb_product_qna_delete_answer', $ans_ID );
        }
    }
