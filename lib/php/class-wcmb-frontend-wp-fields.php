...
if (!class_exists('WCMb_Frontend_WP_Fields')) {

    class WCMb_Frontend_WP_Fields {
        ...
        <span class="dc-wp-fields-uploader">
          ...
          <input type="button" class="upload_button button button-secondary" name="%s_button" id="%s_button" data-mime="%s" value="' . __('Upload', 'MB-multivendor') . '" />
          <input type="button" class="remove_button button button-secondary" name="%s_remove_button" id="%s_remove_button" data-mime="%s" value="' . __('Remove', 'MB-multivendor') . '" />
        </span>
...
//            }
        ...
        public function wcmb_generate_form_field($fields, $common_attrs = array()) {
            if (!empty($fields)) {
