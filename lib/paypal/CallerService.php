...
require_once($WCMb->plugin_path.'lib/paypal/constants.php');
...
{
	global $WCMb, $API_Endpoint,$version,$API_UserName,$API_Password,$API_Signature,$nvp_Header, $subject, $AUTH_token,$AUTH_signature,$AUTH_timestamp;
	// form header string
	$nvpheader=nvpHeader();
