...
define('API_USERNAME', $WCMb->paypal_masspay->api_username);
//
...
define('API_PASSWORD', $WCMb->paypal_masspay->api_pass);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $WCMb->paypal_masspay->api_signature );

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/
if($WCMb->paypal_masspay->test_mode) {
