...
var scrollTab = ( function ( $, W ) {
    ...
    var privateApi = {
        ...
        addNavComponents: function addNavComponents( $navs ) {
            $navs.html( '<button class="nav-btn next"><i class="wcmb-font ico-right-arrow-icon"></i></button><button class="nav-btn prev"><i class="wcmb-font ico-left-arrow-icon"></i></button>' );
            return false;
        },
