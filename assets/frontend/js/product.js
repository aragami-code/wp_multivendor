            ...
            try {
                ...
                $( ':input.wc-product-search' ).filter( ':not(.enhanced)' ).each( function () {
                    var select2_args = {
                        ...
                        ajax: {
                            url: wcmb_advance_product_params.ajax_url,
                            dataType: 'json',
                            delay: 250,
                            data: function ( params ) {
                                return {
                                    ...
                                    security: wcmb_advance_product_params.search_products_nonce,
...
var wcmbAfmProductEditor = ( function ( $ ) {
    var state = {
    ...
    return {
        ...
        init: function ( ) {
            ...
            //save
            $( '#wcmb-edit-product-form' ).on( 'click', '#wcmb_afm_product_submit, #wcmb_afm_product_draft', this.saveProduct.bind( this ) );
        ...
        mediaController: function ( ) {
            ...
            return {
                ...
                removeFeaturedImage: function ( event ) {
                    ...
                    $parent.find( 'img' ).eq( 0 ).attr( 'src', wcmb_advance_product_params.woocommerce_placeholder_img_src );
        ...
        setupEnvironment: function ( ) {
            ...
            wcmbAfmLibrary.wcEnhancedSelectInit();
            wcmbAfmLibrary.wcEnhancedSelectClose();
            wcmbAfmLibrary.qtip();
            ...
            $( ".multiselect.product_tag" ).select2( {
                tags: wcmb_advance_product_params.add_tags,
                tokenSeparators: [ ',' ],
                placeholder: $( this ).data( 'placeholder' ),
            } ).on( "change", function ( ) {
                        ...
                        success: function ( response ) {
                            if ( response.status ) { 
                                ...
                                if ( response.message != '' ) {
                                    ...
                                    $( '#wcmb-afm-add-product' ).prepend( '<div class="woocommerce-error" tabindex="-1">' + response.message + '</div>' );
        ...
        salePriceDateFieldInit: function ( $wrap ) {
            ...
            $( '.sale_price_dates_fields', $wrap ).each( function () {
                ...
                $theseSaleDates.find( 'input' ).datepicker( {
                    ...
                    onSelect: function () {
                        wcmbAfmLibrary.datePickerSelect( $( this ) );
                    }
                } ).on( 'change', function () {
        ...
        updateTabsDisplay: function ( ) {
            ...
            var defaultProductTypes = JSON.parse( wcmb_advance_product_params.default_product_types );
            var productTypes = JSON.parse( wcmb_advance_product_params.product_types );
        ...
        attributeController: function ( ) {
            ...
            return {
                init: function ( ) {
                    ...
                    if ( !wcmb_advance_product_params.custom_attribute ) {
                ...
                initSortableComponent: function ( ) {
                    ...
                    var options = {
                        ...
                        helper: 'clone',
                        opacity: 0.65,
                        placeholder: 'wcmb-metabox-sortable-placeholder',
                        start: function ( event, ui ) {
                            ui.item.css( 'background-color', '#f6f6f6' );
                        },
                        stop: function ( event, ui ) {
                ...
                addAttribute: function ( e ) {
                    ...
                    if ( attribute || wcmb_advance_product_params.custom_attribute == "1" ) {
                        ...
                        var data = {
                            action: 'wcmb_edit_product_attribute',
                            taxonomy: attribute,
                            i: size,
                            security: wcmb_advance_product_params.add_attribute_nonce
                        };
                        ...
                        $.post( wcmb_advance_product_params.ajax_url, data, function ( response ) {
                            if ( response != '-1' ) {
                    ...
                    if ( attribute ) {
                        ...
                        if ( wcmb_advance_product_params.custom_attribute == 1 ) {
                ...
                removeAttribute: function ( e ) {
                    if ( window.confirm( wcmb_advance_product_params.remove_attribute ) ) {
                ...
                saveAttribute: function ( e ) {
                    ...
                    var data = {
                        post_id: wcmb_advance_product_params.product_id,
                        product_type: self.getState( 'productType' ),
                        data: $( '.product_attributes' ).find( 'input, select, textarea' ).serialize(),
                        action: 'wcmb_product_save_attributes',
                        security: wcmb_advance_product_params.save_attributes_nonce
                    };

                    $.post( wcmb_advance_product_params.ajax_url, data, function () {
                        // Reload variations panel.
                        var this_page = window.location.toString();
                        this_page = this_page.replace( /(?:\/#?|\/\d+\/?)?$/, '/' + wcmb_advance_product_params.product_id + '/' );
                        $wrapper.unblock();
                        $wrapper.trigger('wcmb_after_save_attribute_triggered');
...
//                        } );
                ...
                expandAllAttributes: function ( ) {
                    $( this ).closest( '#product_attributes_data' ).find( '.wcmb-metabox-wrapper > .wcmb-metabox-content' ).collapse( 'show' );
                    return false;
                },
                closeAllAttributes: function ( ) {
                    $( this ).closest( '#product_attributes_data' ).find( '.wcmb-metabox-wrapper > .wcmb-metabox-content' ).collapse( 'hide' );
                    return false;
                }
            };
        },
                ...
                variationActionsController: function ( ) {
                    return {
                        ...
                        expandAllVariations: function () {
                          $( this ).closest( '#variable_product_options' ).find( '.wcmb-metabox-wrapper > .wcmb-metabox-content' ).collapse( 'show' );
                          return false;
                        },
                        closeAllVariations: function () {
                          $( this ).closest( '#variable_product_options' ).find( '.wcmb-metabox-wrapper > .wcmb-metabox-content' ).collapse( 'hide' );
                          return false;
                        },
                        reload: function ( ) {
                        ...
                        setMenuOrder: function ( event ) {
                            ...
                            var value = window.prompt( wcmb_advance_product_params.i18n_enter_menu_order, $menuOrder.val() );
                        ...
                        variationRowIndexes: function () {
                            var $wrapper = $( '#variable_product_options' ).find( '.woocommerce_variations' ),
                                ...
                                offset = parseInt( ( currentPage - 1 ) * wcmb_advance_product_params.variations_per_page, 10 );
                ...
                variationAjaxController: function ( ) {
                    return {
                        init: function ( ) {
                            ...
                            $( 'form#wcmb-afm-add-product' ).on( 'submit', this.saveOnSubmit );
                        ...
                        checkForChanges: function () {
                            ...
                            if ( 0 < needUpdate.length ) {
                                if ( window.confirm( wcmb_advance_product_params.i18n_edited_variations ) ) {
                                    this.saveChanges();
                                } else {
                        ...
                        loadVariations: function ( page, perPage ) {
                            page = page || 1;
                            perPage = perPage || wcmb_advance_product_params.variations_per_page;
                            ...
                            $.ajax( {
                                url: wcmb_advance_product_params.ajax_url,
                                data: {
                                    action: 'wcmb_afm_load_variations',
                                    security: wcmb_advance_product_params.load_variations_nonce,
                                    product_id: wcmb_advance_product_params.product_id,
                        ...
                        saveChanges: function ( callback ) {
                            ...
                            if ( 0 < needUpdate.length ) {
                                ...
                                data.security = wcmb_advance_product_params.save_variations_nonce;
                                data.product_id = wcmb_advance_product_params.product_id;
                        ...
                        addVariation: function () {
                            ...
                            var data = {
                                action: 'wcmb_afm_add_variation',
                                post_id: wcmb_advance_product_params.product_id,
                                loop: $( '.woocommerce_variation' ).length,
                                security: wcmb_advance_product_params.add_variation_nonce
                            };
                        ...
                        removeVariation: function () {
                            ...
                            if ( window.confirm( wcmb_advance_product_params.i18n_remove_variation ) ) {
                                ...
                                if ( 0 < variation ) {
                                    ...
                                    data.security = wcmb_advance_product_params.delete_variations_nonce;

                                    $.post( wcmb_advance_product_params.ajax_url, data, function () {
                                        var $wrapper = $( '#variable_product_options' ).find( '.woocommerce_variations' ),
                                            currentPage = parseInt( $wrapper.attr( 'data-page' ), 10 ),
                                            totalPages = Math.ceil( ( parseInt( $wrapper.attr( 'data-total' ), 10 ) - 1 ) / wcmb_advance_product_params.variations_per_page ),
                                            page = 1;
                        ...
                        linkAllVariations: function () {
                            ...
                            if ( window.confirm( wcmb_advance_product_params.i18n_link_all_variations ) ) {
                                this.block();

                                var data = {
                                    action: 'woocommerce_link_all_variations',
                                    post_id: wcmb_advance_product_params.product_id,
                                    security: wcmb_advance_product_params.link_variation_nonce
                                };
                                ...
                                $.post( wcmb_advance_product_params.ajax_url, data, function ( response ) {
                                    ...
                                    if ( 1 === count ) {
                                        window.alert( count + ' ' + wcmb_advance_product_params.i18n_variation_added );
                                    } else if ( 0 === count || count > 1 ) {
                                        window.alert( count + ' ' + wcmb_advance_product_params.i18n_variations_added );
                                    } else {
                                        window.alert( wcmb_advance_product_params.i18n_no_variations_added );
                                    }
                        ...
                        doVariationAction: function () {
                            ...
                            switch ( doVariationAction ) {
                                ...
                                case 'link_all_variations' :
                                    ...
                                    return;
                                case 'delete_all' :
                                    if ( window.confirm( wcmb_advance_product_params.i18n_delete_all_variations ) ) {
                                        if ( window.confirm( wcmb_advance_product_params.i18n_last_warning ) ) {
                                            data.allowed = true;
                                ...
                                case 'variable_sale_price_decrease' :
                                    value = window.prompt( wcmb_advance_product_params.i18n_enter_a_value_fixed_or_percent );

                                    if ( value !== null ) {
                                        if ( value.indexOf( '%' ) >= 0 ) {
                                            data.value = accounting.unformat( value.replace( /\%/, '' ), wcmb_advance_product_params.mon_decimal_point ) + '%';
                                        } else {
                                            data.value = accounting.unformat( value, wcmb_advance_product_params.mon_decimal_point );
                                        }
                                    } else {
                                        return;
                                    }
                                ...
                                case 'variable_download_expiry' :
                                    value = window.prompt( wcmb_advance_product_params.i18n_enter_a_value );
                                ...
                                case 'variable_sale_schedule' :
                                    data.date_from = window.prompt( wcmb_advance_product_params.i18n_scheduled_sale_start );
                                    data.date_to = window.prompt( wcmb_advance_product_params.i18n_scheduled_sale_end );
                            ...
                            $.ajax( {
                                ...
                                data: {
                                    ...
                                    security: wcmb_advance_product_params.bulk_edit_variations_nonce,
                                    product_id: wcmb_advance_product_params.product_id,
                                    product_type: self.getState( 'productType' ),
                    ...
                    return {
                        ...
                        addImage: function ( event ) {
                            ...
                            if ( $button.is( '.remove' ) ) {
                                ...
                                settingVariationImage.find( 'img' ).eq( 0 ).attr( 'src', wcmb_advance_product_params.woocommerce_placeholder_img_src );
                                ...
                                variableImageFrame = wp.media.frames.variable_image = wp.media( {
                                    // Set the title of the modal.
                                    title: wcmb_advance_product_params.i18n_choose_image,
                                    button: {
                                        text: wcmb_advance_product_params.i18n_set_image
                                    },
                                    states: [
                                        new wp.media.controller.Library( {
                                            title: wcmb_advance_product_params.i18n_choose_image,
                ...
                variationPaginationController: function ( ) {
                    return {
                        ...
                        updateVariationsCount: function ( qty ) {
                            ...
                            if ( 1 === total ) {
                                $displayingNum.text( wcmb_advance_product_params.i18n_variation_count_single.replace( '%qty%', total ) );
                            } else {
                                $displayingNum.text( wcmb_advance_product_params.i18n_variation_count_plural.replace( '%qty%', total ) );
                            }
                        ...
                        setPaginav: function ( qty ) {
                            var $wrapper = $( '#variable_product_options' ).find( '.woocommerce_variations' ),
                                ...
                                totalPages = Math.ceil( newQty / wcmb_advance_product_params.variations_per_page ),
                                options = '';
        ...
        saveProduct: function ( e ) { 
            $( 'form#wcmb-edit-product-form' ).trigger( 'before_product_save' );
            var status = ( e.target.id === 'wcmb_afm_product_submit' ) ? 'publish' : ( e.target.id === 'wcmb_afm_product_draft' ) ? 'draft' : '';
