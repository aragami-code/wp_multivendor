...
var couponController = ( function ( $ ) {
    var privateApi = {
        addEventHandlers: function addEventHandlers() {
            $( '#wcmb-afm-add-coupon' )
                .on( 'click', '#wcmb_afm_coupon_submit, #wcmb_afm_coupon_draft', this.saveCoupon )
            ;
            return false;
        },
        ...
        saveCoupon: function saveCoupon() {
            $( 'form#wcmb-afm-add-coupon' ).trigger( 'before_coupon_save' );
            var status = ( this.id === 'wcmb_afm_coupon_submit' ) ? 'publish' : ( this.id === 'wcmb_afm_coupon_draft' ) ? 'draft' : '';
