...
final class WCMb_Woo_Helper {
    ...
    public function __construct() {
        add_action( 'wcmb_init', array( &$this, 'init' ) );
    }
    ...
    public function __clone() {
        _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'MB-multivendor' ), '3.2.3' );
    }
...
if ( ! function_exists( 'wcmb_woo' ) ) {

    function wcmb_woo() {
        return WCMb_Woo_Helper::instance();
    }
