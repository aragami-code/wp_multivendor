...
class WC_Dependencies_Product_Vendor {
    ...
    public static function is_advance_frontend_manager_active() {
        if (!self::$active_plugins)
            self::init();
        return in_array('wcmb-frontend_product_manager/wcmb_frontend_product_manager.php', self::$active_plugins) || array_key_exists('wcmb-frontend_product_manager/wcmb_frontend_product_manager.php', self::$active_plugins);
    }
