...
class WCMb_Settings_Payment_Paypal_Masspay {
    ...
    public function settings_page_init() {
        ...
        $settings_tab_options = array("tab" => "{$this->tab}",
            ...
            "sections" => array(
                "wcmb_payment_paypal_masspay_settings_section" => array("title" => '', // Section one
                    "fields" => array(
                        "api_username" => array('title' => __('API Username', 'MB-multivendor'), 'type' => 'text', 'id' => 'api_username', 'label_for' => 'api_username', 'dfvalue' => $this->paypal_api_username, 'name' => 'api_username'),
                        "api_pass" => array('title' => __('API Password', 'MB-multivendor'), 'type' => 'password', 'id' => 'api_pass', 'label_for' => 'api_pass', 'name' => 'api_pass', 'dfvalue' => $this->paypal_api_password),
                        "api_signature" => array('title' => __('API Signature', 'MB-multivendor'), 'type' => 'password', 'id' => 'api_signature', 'label_for' => 'api_signature', 'name' => 'api_signature', 'dfvalue' => $this->paypal_api_signature),
     ...
     */
    public function wcmb_payment_paypal_masspay_settings_sanitize($input) {
        global $WCMb;
        $new_input = array();
        $hasError = false;
        ...
        if (!$hasError) {
            add_settings_error(
                    "wcmb_{$this->tab}_{$this->subsection}_settings_name", esc_attr("wcmb_{$this->tab}_{$this->subsection}_settings_admin_updated"), __('Paypal Masspay Settings Updated', 'MB-multivendor'), 'updated'
            );
        }
